      ...
      >
        ...
        >
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.radioRow}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Text style={[styles.radioOptionText, !isMerchant && styles.radioOptionTextActive]}>
                    Non
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
            ...
            {/* Section commerçant conditionnelle */}
            {isMerchant && (
...
const styles = StyleSheet.create({
  ...
  merchantSection: {
    ...
    paddingTop: 16,
    borderTopWidth: 1,
    borderTopColor: SURFACE_CONTAINER_LOW,
  },
